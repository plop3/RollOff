...
#define INTERVALLEPORTES  20000   // Intervalle entre la fermeture de la porte 1 et de la porte 2
...
#define HUMMAX            20      // 20 Taux d'humidité maxi pour le capteur de pluie (20)
